...
all: coreuv-utils.o coreuv.o
	$(CC) -o main test/main.m coreuv.o http-parser/http_parser.o coreuv-utils.o -x c -fblocks -l:libgnustep-corebase.so.0.1 -lgnustep-base -lgnustep-corebase -lgnustep-gui -ldispatch -lcurl -ltidy -lxml2 -luv -I/usr/local/include -L/usr/local/lib -I/usr/include/libxml2 -L/usr/lib -I/srv/coreuv/http-parser -L/srv/coreuv/http-parser
